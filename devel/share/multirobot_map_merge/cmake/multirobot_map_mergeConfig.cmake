...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/cc/ee106b/sp24/class/ee106b-abz/MYST-106B/src/m-explore/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/cc/ee106b/sp24/class/ee106b-abz/MYST-106B/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/cc/ee106b/sp24/class/ee106b-abz/MYST-106B/install)
...
if(NOT "/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp24/class/ee106b-abz/MYST-106B/src/m-explore/map_merge/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cc/ee106b/sp24/class/ee106b-abz/MYST-106B/devel/lib;/opt/ros/noetic/lib)
